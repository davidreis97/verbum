            ...
            <Box>
                {
                    props.players.sort((a, b) => b.score - a.score).map((p, i) =>
                        <MotionBox borderRadius="1em" backgroundColor={p.name == username ? "rgb(255,255,255,0.1)" : ""} padding="0.25em 0 0.25em 0" margin="0 0.5em 0 0.5em" display="flex" key={p.name} layout="position" initial="hidden" animate="show" variants={smoothIn(0, -50)} transition={springTransition}>
